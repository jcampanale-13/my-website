...
export default function Projects() {
    return (
      <div className="flex flex-col items-center">
        ...
        <div className="flex justify-center flex-wrap gap-4 my-16 items-start">
            ...
            <Project title="Custom DevOps Dashboard" content={DESCRIPTIONS_CONSTANTS.NAVI} img={optum} imgAlt="Logo for Optum"/>
